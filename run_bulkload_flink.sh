...
SCYLLA_RDF_MAX_REQUESTS_PER_CONNECTION="${SCYLLA_RDF_MAX_REQUESTS_PER_CONNECTION:-512}"
SCYLLA_RDF_PIPELINE_SKIP_FULLTEXTSEARCH_INDEX="${SCYLLA_RDF_PIPELINE_SKIP_FULLTEXTSEARCH_INDEX:-false}"
...
java ${JAVA_OPTS} -jar ${SCYLLA_RDF_PIPELINES_JAR} --runner=FlinkRunner --hosts=${SCYLLA_RDF_STORAGE_HOSTS} \
    ...
    --maxRequestsPerConnection=${SCYLLA_RDF_MAX_REQUESTS_PER_CONNECTION} \
    --skipFullTextIndex=${SCYLLA_RDF_PIPELINE_SKIP_FULLTEXTSEARCH_INDEX} \
